...
import com.ldy.flexframe.base.view.FlexBaseFragment;
<#if !includeLayout>import android.widget.TextView;</#if>
<#if applicationPackage??>
import ${applicationPackage}.R;
import ${applicationPackage}.databinding.Fragment${business}Binding;
</#if>

/**
 * A simple {@link FlexBaseFragment} subclass.
<#if includeCallbacks>
 ...
 *
 */
public class ${className} extends FlexBaseFragment<${presenterClass},Fragment${business}Binding> {
<#if includeFactory>
